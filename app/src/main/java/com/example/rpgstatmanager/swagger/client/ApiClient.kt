...
import com.example.rpgstatmanager.swagger.client.auth.ApiKeyAuth
import com.example.rpgstatmanager.swagger.client.auth.HttpBasicAuth
import com.example.rpgstatmanager.swagger.client.auth.OAuth
import com.example.rpgstatmanager.swagger.client.auth.OAuth.AccessTokenListener
...
class ApiClient() {
    ...
    fun createDefaultAdapter() {
        ...
        var baseUrl = "https://rpgmanager.data.io/v2"
