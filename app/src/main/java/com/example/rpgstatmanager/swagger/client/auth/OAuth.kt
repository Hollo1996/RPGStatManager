package com.example.rpgstatmanager.swagger.client.auth
...
class OAuth(client: OkHttpClient?, requestBuilder: TokenRequestBuilder) :
    ...
    private val oauthClient: OAuthClient = OAuthClient(OAuthOkHttpClient(client!!))
    var tokenRequestBuilder: TokenRequestBuilder = requestBuilder
