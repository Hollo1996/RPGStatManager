...
class CharacterInteractor @Inject constructor(
    ...
    override fun delete(d: D_Character) = dataApi.deleteCharacter(AuthInteractor.actualToken, d.id)

    override fun list() =
        dataApi.listCharacters(AuthInteractor.actualToken, PathTracker.adventure)
            .map {
